...
export interface VampireStakeV2HelperInterface extends utils.Interface {
  functions: {
    ...
    "setBleedRate(uint256)": FunctionFragment;
    "setHuntDuration(uint256)": FunctionFragment;
    "setHuntOver(uint256)": FunctionFragment;
    ...
    "unluckyNumber()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "unluckyNumber",
    values?: undefined
  ): string;
...
export interface VampireStakeV2Helper extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: VampireStakeV2HelperInterface;
  ...
  functions: {
    ...
    setBleedRate(
      _bleedRate: PromiseOrValue<BigNumberish>,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
    ...
    setHuntOver(
      _huntOver: PromiseOrValue<BigNumberish>,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
    ...
    unluckyNumber(overrides?: CallOverrides): Promise<[BigNumber]>;
  ...
  populateTransaction: {
    ...
    unluckyNumber(overrides?: CallOverrides): Promise<PopulatedTransaction>;
